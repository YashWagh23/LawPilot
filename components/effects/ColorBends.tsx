...
export default function ColorBends({
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      material.dispose();
      renderer.dispose();
      // Safely check if forceContextLoss exists on renderer
      const r = renderer as unknown as { forceContextLoss?: () => void };
      if (typeof r.forceContextLoss === "function") {
        r.forceContextLoss();
      }
  ...
  useEffect(() => {
    ...
    // Attach to window so pointer movement is tracked smoothly across the entire viewport
